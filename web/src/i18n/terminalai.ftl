...
update-available = TerminalAI v{ $latest } is available (installed v{ $current }). Download it from GitHub; nothing was installed automatically.
...
status-stalled-detail = No progress reported for over { $minutes } minutes; it may be wedged rather than busy

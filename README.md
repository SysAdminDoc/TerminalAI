...
- 116 default tests over the flag mapping, real-pty boundary, supervision state machine, registry,
  diagnostics, review aggregation, daemon protocol, presets, launch golden fixtures, atomic file
  recovery, corrupt-store quarantine, deterministic fleet ordering, prompt safety and fleet-row model; 118

...
**v0.15.0 — core and desktop shell built, installed, and verified end to end.**
...
- 585 default Rust tests over agent identification and resolution against an injected filesystem,
  ...
  over state passed in; 588 with the opt-in

...
launches the real CLI on a pseudo-console and puts it in a dense fleet list. Thirty live
...
- 16 unit tests over the flag mapping and the fleet-row model
...
| Permission | `--permission-mode default\|plan\|acceptEdits\|bypassPermissions` | `--ask-for-approval on-request\|untrusted\|never` |
